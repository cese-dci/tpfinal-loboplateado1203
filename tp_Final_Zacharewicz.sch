...
Comment1 "FIUBA - CESE"
Comment2 "Alumna: Lorena  B. Zacharewicz"
Comment3 "Revisor: Ingnacio Majul"
Comment4 "Licencia:Open Source"
$EndDescr
$Comp
...
F 2 "modelos:CJMCU TXB0108 Arduino" H 7800 4700 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/txb0108.pdf" H 7800 5350 50  0001 C CNN
	1    7800 5450
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
F 1 "LM7805" H 2000 6900 50  0000 C CNB
F 2 "Package_TO_SOT_THT:TO-220-3_Vertical" H 2000 6975 50  0001 C CIN
F 3 "http://www.fairchildsemi.com/ds/LM/LM7805.pdf" H 2000 6700 50  0001 C CNN
	1    2000 6750
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/40300c.pdf" H 8450 2300 50  0001 C CNN
	1    8450 2300
	-1   0    0    -1  
$EndComp
$Comp
...
U 1 1 5EFB01D8
P 9600 4450
F 0 "XA1" H 9950 4997 60  0000 C CNN
F 1 "Conn_Poncho2P_2x_20x2" H 9950 4891 60  0000 C CNN
F 2 "footprint:Conn_Poncho_Completo" H 9600 4450 60  0001 C CNN
...
U 2 1 5FFEEEAB
P 1250 2150
F 0 "XA1" H 1600 2697 60  0000 C CNN
F 1 "Conn_Poncho2P_2x_20x2" H 1600 2591 60  0000 C CNN
F 2 "footprint:Conn_Poncho_Completo" H 1250 2150 60  0001 C CNN
...
F 7 "modelos/Basico/lib/basico.lib" H 1250 2150 50  0001 C CNN "Spice_Lib_File"
	2    1250 2150
	1    0    0    -1  
$EndComp
Wire Wire Line
